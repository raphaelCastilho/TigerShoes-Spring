		...
		<div class="panel-group" id="accordion">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapseOne"> <span class="glyphicon glyphicon-tags">
						</span> Roupas
						</a>
					</h4>
				</div>
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						<table class="table">
							<tr>
								<td><a href="http://www.jquery2dotnet.com">Blusas</a></td>
							</tr>
							<tr>
								<td><a href="http://www.jquery2dotnet.com">Bermudas</a></td>
							</tr>
							<tr>
								<td><a href="http://www.jquery2dotnet.com">Calças</a></td>
							</tr>
						</table>
					</div>
				</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="#collapseTwo"> <span class="glyphicon glyphicon-tags"></span>
							Calçados
						</a>
					</h4>
				</div>
				<div id="collapseTwo" class="panel-collapse collapse">
					<div class="panel-body">
						<table class="table">
							<tr>
								<td><a href="http://www.jquery2dotnet.com">Tênis</a>
							</tr>
							<tr>
								<td><a href="http://www.jquery2dotnet.com">Sapatos</a></td>
							</tr>
							<tr>
								<td><a href="http://www.jquery2dotnet.com">Chinelos</a></td>
							</tr>
						</table>
					</div>
				</div>
